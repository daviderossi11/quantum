...
FF-QRAM Depth XGate e FF-QRAM Depth GrayCode. Vengono utilizzati vari livelli di ottimizzazione e opzioni di barriera 
...
for opt_level in optimization_levels:
    for barrier in barrier_options:
        ...
        plt.plot(datasize, gray_opt_size, marker='o', color='green', linewidth=2, label='FF-QRAM Depth GrayCode')
